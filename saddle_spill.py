...
def saddle_spill(model):
    ...
    #     if sp.id_pnt == 25105:
    #         print("-------Point 25105 avant traitement dans saddle_spill--------")
    ...
    #         print("id_eo1 : ", id_eo1)
    #         print("id_eo2 : ", id_eo2)
    #         print("model.l_endo_pt[id_eo1-1] : ", model.l_endo_pt[id_eo1-1])
    #         print("model.l_endo_pt[id_eo2-1] : ", model.l_endo_pt[id_eo2-1])


    # Process each saddle point in sorted order.
    # with open("output_saddle_points_mini_mini.txt", "w") as file:
    for cnt_sdl in tqdm(range(len(qoi))):
        ...
        # file.write(f"\n{id_sdl} ; {model.sdl_pt[id_sdl-1].i} ; {model.sdl_pt[id_sdl-1].j} ; {id_eo1} ; {id_eo2} ; \n{model.l_endo_pt[id_eo1-1].bas_type} ; {model.l_endo_pt[id_eo2-1].bas_type}")
        # print(f"--------On traite le point {id_sdl} dans saddle_spill--------")
        # print("id_eo1 : ", id_eo1)
        # print("id_eo2 : ", id_eo2)
        # print("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
        # print("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
    ...
    # for sp in model.sdl_pt:
    #     if sp.id_pnt == 25105:
    #         print("-------Point 25105 après traitement dans saddle_spill--------")
    #         rp = model.rd_pt[sp.id_rdpt-1]
    #         id_eo1 = model.dr_net[model.dr_pt[rp.id_drpt1.value-1].id_ch.value-1].id_endo.value
    #         id_eo2 = model.dr_net[model.dr_pt[rp.id_drpt2.value-1].id_ch.value-1].id_endo.value
    #         print ("sp : ", sp)
...
#                 print("model.l_endo_pt[qoi_etmp[cnt_qoi]-1].idms.value : ", model.l_endo_pt[qoi_etmp[cnt_qoi]-1].idms.value)
#                 print("cnt_qoi : ", cnt_qoi)
#                 print("qoi_stmp :", qoi_stmp)
#                 print("qoi_etmp : ", qoi_etmp)
#                 print("qoi_sdl : ", qoi_sdl)
#                 print("qoi_endo : ", qoi_endo)
                
#                 print("model.rd_pt[model.l_endo_pt[qoi_etmp[cnt_qoi]-1].idms.value[qoi_stmp[cnt_qoi]]-1].Z : ", model.rd_pt[model.l_endo_pt[qoi_etmp[cnt_qoi]-1].idms.value[qoi_stmp[cnt_qoi]]-1].Z)
...
#         rp = model.rd_pt[model.l_endo_pt[curr-1].idms.value[id_sdl]-1] # !!!!!!! J'ai rajouté -1 à id_sdl-1. 
#         zs_cur = rp.Z
#         nsdl = model.l_endo_pt[curr-1].nsaddle
...
#         if zs_cur <= max_Zs:
#             id_eo1 = curr
#             id_eo2 = model.l_endo_pt[curr-1].beyo_sad.value[id_sdl] #!!!!!!! pas certain du id_sdl-1
            
#             print(f"On traite id_eo1 = {id_eo1} et id_eo2 = {id_eo2} dans endo_out")
#             print ("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
#             print ("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
#             if id_eo1 == 56 and id_eo2 == 54:
#                 print("on a id_eo1 == 56 .and. id_eo2 == 54 dans endo_out")
#                 print("model.l_endo_pt[curr-1].beyo_sad.value", model.l_endo_pt[curr-1].beyo_sad.value)
#                 print("nsdl : ", nsdl)
#                 print("id_sdl : ", id_sdl)
#                 print("qoi_sdl : ", qoi_sdl)
#                 print("cnt_sdl : ", cnt_sdl)
#                 print("qoi_stmp : ", qoi_stmp)
#                 print("n_el : ", n_el)
#                 print("qoi_endo : ", qoi_endo)
#                 print("curr_init : ", curr_init)
                
#                 sys.exit(0)

            
#             # if id_eo1 == 53 or id_eo2 == 53:
#             #     print ("On traite id_eo = 53 dans endo_out")
#             #     print ("id_eo1 = ", id_eo1)
#             #     print ("id_eo2 = ", id_eo2)
#             #     print ("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
#             #     print ("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
...
#             # if id_eo1 == 53 or id_eo2 == 53 or id_eo1 == 55 or id_eo2 == 55:
#             #     print("Un point endoerique d\'interet est traité dans endo_out")
#             #     if id_eo1 == 53:
#             #         print ("On traite id_eo1 == 53")
#             #         print ("id_eo2 a pour valeur : ", id_eo2)
#             #         print ("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
#             #         print ("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
                
#             #     if id_eo2 == 53:
#             #         print ("On traite id_eo2 == 53")
#             #         print ("id_eo1 a pour valeur : ", id_eo1)

#             #         print ("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
#             #         print ("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
                
#             #     if id_eo1 == 55:
#             #         print ("On traite id_eo1 == 55")
#             #         print ("id_eo2 a pour valeur : ", id_eo2)
...
def endo_out(curr, max_Zs, model):
    ...
    while n_qoi > 0:
        ...
        if zs_cur <= max_Zs:
            ...
            # print ("model.l_endo_pt[id_eo1-1].bas_type : ", model.l_endo_pt[id_eo1-1].bas_type)
            # print ("model.l_endo_pt[id_eo2-1].bas_type : ", model.l_endo_pt[id_eo2-1].bas_type)
            # if id_eo1 == 56 and id_eo2 == 55:
            #     print("on a id_eo1 == 56 .and. id_eo2 == 55 dans endo_out")
            #     print("model.l_endo_pt[curr-1].beyo_sad.value", model.l_endo_pt[curr-1].beyo_sad.value)
            #     print("nsdl : ", nsdl)
            #     print("id_sdl : ", id_sdl)
            #     print("qoi_sdl : ", qoi_sdl)
